...
public class LayCodeHTML {
    ...
    public void layVaLuuTKBHtml() {
        try (Playwright playwright = Playwright.create()) {
            ...
            page.navigate("https://daotao.vnua.edu.vn/dkmh/#/dangkymonhoc", new Page.NavigateOptions().setTimeout(30000));
            
            // Kiểm tra trang đã tải thành công
            ...
            // Lấy container của dropdown
            Locator dropdownContainer = page.locator("[role='listbox']");

            // Cuộn qua toàn bộ dropdown để tải hết các phần tử
            int lastCount = 0;
            int currentCount = 0;
            do {
            ...
            // Lấy tất cả các phần tử trong dropdown và trích xuất index
            ...
            if (activeId != null) {
                ...
                if (m.matches()) {
                    ...
                    // Cuộn phần tử đang chọn vào view
                ...
                System.out.println("Không tìm thấy aria-activedescendant");
            }
            ...
            // 3. Đảm bảo bảng thời khóa biểu đã xuất hiện
